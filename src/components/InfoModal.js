    ...
    <div className={`h-full ${darkMode ? 'dark' : ''}`}>
      ...
      <div className="h-full flex flex-col items-center justify-center max-w-[390px] mx-auto pt-9 text-primary dark:text-primary-dark">
        <div className="flex-1 w-full sm:text-base text-sm">
          <h1 className="text-center sm:text-3xl text-2xl">Spielanleitung</h1>
          <ul className="list-disc pl-5 block sm:text-base text-sm">
            <li className="mt-6 mb-2">Du hast sechs Versuche das richtige Wort zu finden.</li>
            <li className="mb-2">Du kannst jedes Wort eingeben. Das Lösungswort ist kein Verb.</li>
            <li className="mb-2">
              Nach jedem Versuch werden die Buchstaben entweder grün, gelb oder grau.
            </li>
          </ul>
          <div className="mb-3 mt-8 flex items-center">
            ...
            <span>Korrekter Buchstabe, korrekte Position</span>
          </div>
          <div className="mb-3">
